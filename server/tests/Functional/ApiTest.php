...
class ApiTest extends BaseTestCase
{
  ...
  {
    $response = $this->runApp('GET', '/auth', null, [
      'user' => 'admin',
      'password' => 'x'
    ]);
  ...
  {
    $response = $this->runApp('DELETE', '/group/test', null, [
      'user' => 'admin',
      'password' => 'admin'
    ]);
    $this->assertEquals(200, $response->getStatusCode());
  ...
  {
    $response = $this->runApp('POST', '/group/test/members/bot', null, [
      'user' => 'bot',
      'password' => 'bot'
    ]);
    $this->assertEquals(200, $response->getStatusCode());
  ...
  {
    $response = $this->runApp('DELETE', '/group/test/members/lea', null, [
      'user' => 'lea',
      'password' => 'lea123'
    ]);
    $this->assertEquals(200, $response->getStatusCode());
  ...
  {
    $response = $this->runApp('DELETE', '/group/test/event/test-1', null, [
      'user' => 'lea',
      'password' => 'lea123'
    ]);
    $this->assertEquals(200, $response->getStatusCode());
